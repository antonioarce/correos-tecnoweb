...
import core.presentador.Bloque;
import core.presentador.Tablero;
import core.presentador.Tabla;
...
public class Herramientas {
    ...
    public static String dibujarTabla(DefaultTableModel tabla) {
        ...
        Tablero board = new Tablero(450);
        Tabla table = new Tabla(board, 450, headers, rowList);
